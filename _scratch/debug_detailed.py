...
def sim(start, days, ret, vol, seed, jp=0.02, js=0.04):
...
async def main():
    await debug('TSLA', 250, 252, 0.40, 0.65, 1525)
    await debug('AAPL', 180, 252, 0.15, 0.25, 1002)
    await debug('META', 550, 252, -0.20, 0.35, 1004)
