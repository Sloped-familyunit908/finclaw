...
async def run_wt(h):
    ...
    r = await bt.run("TEST","WhaleTrader v6",h)
    bh = h[-1]["price"]/h[0]["price"]-1
...
async def main():
    print("\n" + "="*90)
    print("  WhaleTrader v6 -- BENCHMARK (High-Participation + Pyramiding)")
    print("="*90 + "\n")
    ...
    print(f"  {'Scenario':<24}  {'B&H':>7} | {'WT v6':>7} {'a':>7} | {'FT':>7} {'a':>7} | {'AHF':>7} {'a':>7}")
    print("  " + "-"*87)
    ...
    print("  " + "-"*70)
    print(f"  >> WhaleTrader v6      {wt_a:>+9.2%} {wt_dd:>10.2%}   {wt_wins_ft}/{wt_wins_ahf}/{wt_wins_both} of {N}")
    ...
    if wt_a > ahf_a:
        print(f"\n  >>> VICTORY! WhaleTrader v6 BEATS ALL COMPETITORS! <<<")
    elif wt_a > ft_a:
