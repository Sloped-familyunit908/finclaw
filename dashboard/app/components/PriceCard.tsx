...
export default function PriceCard({ data }: { data: MarketData }) {
  ...
  return (
    <div className="group rounded-xl border border-gray-800/60 bg-[#13131a] p-4 sm:p-5 hover:border-orange-800/40 transition-all hover:shadow-lg hover:shadow-orange-950/10">
