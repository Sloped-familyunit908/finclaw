"""
Factor: crypto_bull_power_composite
Description: Combines: RSI>50 + MACD>0 + price>EMA24 + vol>avg
Category: crypto
"""

FACTOR_NAME = "crypto_bull_power_composite"
FACTOR_DESC = "Combines: RSI>50 + MACD>0 + price>EMA24 + vol>avg"
FACTOR_CATEGORY = "crypto"


def compute(closes, highs, lows, volumes, idx):
    """Returns float in [0, 1]. High = multiple bullish signals aligned."""
    if idx < 50:
        return 0.5
