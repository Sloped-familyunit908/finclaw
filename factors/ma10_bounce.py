"""
Factor: ma10_bounce
Description: Price bouncing off 10-day MA from below
Category: moving_average
"""

FACTOR_NAME = "ma10_bounce"
FACTOR_DESC = "Price bouncing off 10-day MA from below"
FACTOR_CATEGORY = "moving_average"


def compute(closes, highs, lows, volumes, idx):
    """Close was below MA10 yesterday, close is above or touching MA10 today."""
    period = 10
    if idx < period + 1:
        return 0.5
